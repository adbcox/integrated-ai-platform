...
- **ID:** `RM-REFACTOR-027`
- **Title:** Replace os.path with pathlib.Path in bin/stage6_manager.py
- **Category:** `REFACTOR`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Convert all os.path calls to Path operations in stage6_manager.py.

## Deliverable

bin/stage6_manager.py — fully pathlib-ified
