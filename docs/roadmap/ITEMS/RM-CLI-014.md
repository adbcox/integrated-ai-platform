...
- **ID:** `RM-CLI-014`
- **Title:** CLI tool: deploy trained model
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/train deploy — write Modelfile and run ollama create qwen2.5-coder:custom.

## Deliverable

bin/train_cli.py — deploy subcommand calling _deploy_model() logic (35 lines)
