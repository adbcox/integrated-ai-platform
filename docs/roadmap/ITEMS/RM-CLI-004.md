...
- **ID:** `RM-CLI-004`
- **Title:** CLI tool: update item status
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/roadmap status RM-TESTING-100 Completed — update Status field and commit the change.

## Deliverable

bin/roadmap_cli.py — status subcommand with git commit (45 lines)
