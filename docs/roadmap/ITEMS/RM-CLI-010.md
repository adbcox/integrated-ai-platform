...
- **ID:** `RM-CLI-010`
- **Title:** CLI tool: tail executor log
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/executor logs --lines 50 — stream executor log to stdout with ANSI color for ✅/❌.

## Deliverable

bin/executor_cli.py — logs subcommand with follow mode (40 lines)
