...
Decorator that retries a function up to N times with 2^attempt second delays on specified exceptions.

## Deliverable

framework/util/retry.py — @retry(max_attempts=3, exceptions=(Exception,)) decorator (50 lines)
