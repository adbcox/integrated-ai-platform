...
Context manager that creates a unique temp dir, yields its path, and cleans up on exit.

## Deliverable

framework/util/tempdir.py — temp_dir() context manager using tempfile.mkdtemp (25 lines)
