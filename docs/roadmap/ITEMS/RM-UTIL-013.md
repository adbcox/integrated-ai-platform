...
Compute SHA256 of a file in chunks (memory-safe for large files) and return hex digest.

## Deliverable

framework/util/file_hash.py — sha256_file(path: Path) -> str (30 lines)
