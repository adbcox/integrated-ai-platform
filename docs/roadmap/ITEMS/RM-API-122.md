...
Lightweight liveness check returning {ok: true, uptime_seconds, version} with no heavy computation.

## Deliverable

web/dashboard/server.py — _serve_health() handler (20 lines added)
