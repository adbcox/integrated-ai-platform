...
- **ID:** `RM-DATA-108`
- **Title:** Roadmap item bulk status updater
- **Category:** `DATA`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Accept a CSV of id,new_status and update all matching RM-*.md files atomically.

## Deliverable

bin/bulk_update_status.py — bulk_update(csv_path, dry_run=True) (50 lines)
