...
- **ID:** `RM-UTIL-024`
- **Title:** Naive CSV writer without stdlib csv
- **Category:** `UTIL`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Write list-of-dicts to CSV string handling commas, quotes, and newlines in values.

## Deliverable

framework/util/csv_writer.py — to_csv(rows, fieldnames) -> str (40 lines)
