...
- **ID:** `RM-USERMGMT-004`
- **Title:** Password policy and management
- **Category:** `USERMGMT`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Implement password policies, secure password reset, password history tracking, and complexity requirements.
