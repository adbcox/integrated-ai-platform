...
- **ID:** `RM-TESTING-111`
- **Title:** Unit tests for heartbeat.py
- **Category:** `TESTING`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Test HeartbeatMonitor detects stale log (no update >5 min) and triggers restart callback.

## Deliverable

tests/test_heartbeat.py — 6 test cases using time.time patching
