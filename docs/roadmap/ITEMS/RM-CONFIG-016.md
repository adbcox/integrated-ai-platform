...
Create config/rate_limits.json defining per-endpoint rate limits for the dashboard API.

## Deliverable

config/rate_limits.json — endpoint→{requests_per_minute, burst} mapping
