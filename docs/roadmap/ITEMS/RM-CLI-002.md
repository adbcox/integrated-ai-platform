...
- **ID:** `RM-CLI-002`
- **Title:** CLI tool: list executable items
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/roadmap list --filter CAT --max 20 — show items the executor would pick next.

## Deliverable

bin/roadmap_cli.py — list subcommand calling find_executable_items() (40 lines)
