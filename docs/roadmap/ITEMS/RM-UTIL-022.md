...
Parse '1-5,7,10-12' range strings into a sorted list of integers for CLI batch selection.

## Deliverable

framework/util/range_parser.py — parse_range(s: str) -> list[int] (35 lines)
