...
- **ID:** `RM-DATA-121`
- **Title:** Execution metrics aggregator
- **Category:** `DATA`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Aggregate per-run execution metrics into a daily summary JSONL for trend analysis.

## Deliverable

bin/aggregate_exec_metrics.py — aggregate(log_dir, output_path) (55 lines)
