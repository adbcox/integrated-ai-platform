...
- **ID:** `RM-REFACTOR-026`
- **Title:** Replace os.path with pathlib.Path in bin/stage3_manager.py
- **Category:** `REFACTOR`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Convert all os.path calls to Path operations in stage3_manager.py.

## Deliverable

bin/stage3_manager.py — fully pathlib-ified
