...
- **ID:** `RM-DATA-112`
- **Title:** Roadmap progress CSV exporter
- **Category:** `DATA`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Export current roadmap status to CSV: id, title, category, status, completion_date (from git log).

## Deliverable

bin/export_roadmap_csv.py — export_progress(output_path) (55 lines)
