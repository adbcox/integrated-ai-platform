...
- **ID:** `RM-CLI-019`
- **Title:** CLI tool: show blocked items
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/roadmap blocked — list items with unmet dependencies and name the blocking items.

## Deliverable

bin/roadmap_cli.py — blocked subcommand reading dep graph (40 lines)
