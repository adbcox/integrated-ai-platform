...
Parse https and ssh git remote URLs into {host, owner, repo} dict without regex.

## Deliverable

framework/util/git_url.py — parse_remote(url: str) -> dict (40 lines)
