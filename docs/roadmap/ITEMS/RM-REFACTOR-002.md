...
- **ID:** `RM-REFACTOR-002`
- **Title:** Add type hints to framework/state_store.py
- **Category:** `REFACTOR`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Add type annotations to StateStore methods: put, get, delete, list_keys.

## Deliverable

framework/state_store.py — fully annotated, no untyped defs
