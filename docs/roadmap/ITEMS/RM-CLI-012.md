...
bin/train start — validate prereqs and spawn run_training_cycle.py with venv activation.

## Deliverable

bin/train_cli.py — start subcommand with prereq validation (40 lines)
