...
Create config/dashboard.json for poll_interval, max_git_commits, chart colors, and feature toggles.

## Deliverable

config/dashboard.json — all tunable dashboard parameters in one file
