...
Ensure all API error paths return JSON {ok: false, error: '...'} instead of HTML error pages.

## Deliverable

web/dashboard/server.py — override send_error() to return JSON; wrap all handlers in try/except (35 lines)
