...
Parse `git diff --stat` output into {files_changed, insertions, deletions} dict.

## Deliverable

framework/util/diff_stat.py — parse_diff_stat(stat_output: str) -> dict (35 lines)
