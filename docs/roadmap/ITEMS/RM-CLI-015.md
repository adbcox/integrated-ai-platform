...
- **ID:** `RM-CLI-015`
- **Title:** CLI tool: health check all services
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/platform health — ping Ollama, dashboard, executor log freshness and print colored status table.

## Deliverable

bin/platform_cli.py — health subcommand (40 lines)
