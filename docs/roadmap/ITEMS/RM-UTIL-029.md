...
Deep-merge two config dicts (base + override) where override values win at leaf level.

## Deliverable

framework/util/config_merge.py — deep_merge(base: dict, override: dict) -> dict (35 lines)
