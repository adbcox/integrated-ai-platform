...
Compute edit distance between two strings for fuzzy command matching in CLI utilities.

## Deliverable

framework/util/levenshtein.py — distance(a: str, b: str) -> int with DP impl (30 lines)
