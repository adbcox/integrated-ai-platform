...
Token-bucket rate limiter: acquire(n=1) blocks until n tokens available at rate R/sec.

## Deliverable

framework/util/rate_limiter.py — RateLimiter(rate, capacity) class (50 lines)
