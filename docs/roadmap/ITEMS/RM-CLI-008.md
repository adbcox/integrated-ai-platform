...
bin/executor start --filter UX --max 10 — start auto_execute_roadmap.py with given args.

## Deliverable

bin/executor_cli.py — start subcommand with conflict detection (40 lines)
