...
- **ID:** `RM-API-108`
- **Title:** GET /api/logs/tail endpoint
- **Category:** `API`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Serve last N lines of active executor log as JSON array of strings.

## Deliverable

web/dashboard/server.py — _serve_log_tail(n=50) handler (30 lines added)
