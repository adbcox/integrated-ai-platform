...
- **ID:** `RM-API-109`
- **Title:** GET /api/diff/<hash> endpoint
- **Category:** `API`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Return both stat and full diff for a git commit hash as JSON.

## Deliverable

web/dashboard/server.py — _serve_diff(hash) handler (35 lines, already partial — clean up and document)
