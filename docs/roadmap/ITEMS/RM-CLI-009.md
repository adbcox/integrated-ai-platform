...
bin/executor stop — send SIGTERM then SIGKILL to running executor process.

## Deliverable

bin/executor_cli.py — stop subcommand using SIGTERM+SIGKILL logic (35 lines)
