...
- **ID:** `RM-MONITOR-008`
- **Title:** Alert rule: training process crashed
- **Category:** `MONITOR`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Detect training_cycle.log contains 'Error' or 'Traceback' and training PID is gone.

## Deliverable

framework/alerts/training_crashed.py — TrainingCrashedAlert (45 lines)
