...
Create config/security.json with allowed_tools, blocked_paths, max_file_size, and audit_log settings.

## Deliverable

config/security.json — permission_engine.py configuration with rationale comments
