...
- **ID:** `RM-API-111`
- **Title:** GET /api/workers/health endpoint
- **Category:** `API`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Return per-worker status: pid, current_item, elapsed, memory for all active executor processes.

## Deliverable

web/dashboard/server.py — _serve_worker_health() (50 lines added)
