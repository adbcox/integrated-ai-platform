...
- **ID:** `RM-MONITOR-029`
- **Title:** Executor log tail API endpoint
- **Category:** `MONITOR`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Add GET /api/logs/tail?lines=50 returning last N lines of active executor log as JSON array.

## Deliverable

web/dashboard/server.py — _log_tail(n) handler (30 lines)
