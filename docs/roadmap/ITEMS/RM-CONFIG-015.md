...
Create config/plugin_schema.json (JSON Schema) for validating plugin.json manifests.

## Deliverable

config/plugin_schema.json — JSON Schema draft-7 with required fields and type validation
