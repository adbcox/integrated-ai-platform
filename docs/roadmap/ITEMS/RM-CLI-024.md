...
- **ID:** `RM-CLI-024`
- **Title:** CLI tool: bulk status update from CSV
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/roadmap bulk-update statuses.csv --dry-run — update item statuses from CSV file.

## Deliverable

bin/roadmap_cli.py — bulk-update subcommand (35 lines)
