...
- **ID:** `RM-CLI-011`
- **Title:** CLI tool: show training status
- **Category:** `CLI`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
bin/train status — parse training_cycle.log and print step/total, phase, ETA, loss.

## Deliverable

bin/train_cli.py — status subcommand (40 lines)
