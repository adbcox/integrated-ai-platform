...
Format Unix timestamps to ISO 8601, relative ('3 min ago'), and log-file-safe strings.

## Deliverable

framework/util/timestamp.py — fmt_iso(), fmt_relative(), fmt_log(ts: float) -> str (40 lines)
