...
- **ID:** `RM-API-102`
- **Title:** Slack webhook POST client
- **Category:** `API`
- **Type:** `Feature`
- **Status:** `Accepted`
- **Maturity:** `M0`
...
Send a Slack message via webhook URL with retry on transient HTTP errors.

## Deliverable

framework/api/slack_client.py — SlackClient.post(payload: dict) -> bool (45 lines)
