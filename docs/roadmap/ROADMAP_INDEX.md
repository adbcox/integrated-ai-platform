...
| ID | Type | Priority | Title |
|---|---|---:|---|
| RM-UI-001 | Feature | High | Master control center for the system with web-first UI, tablet support, and later app-based surfaces |
| RM-UI-002 | Feature | High | No-code primary user interface with click-tile navigation for apps and functions |
| RM-UI-003 | Feature | High | Tablet-specialized ambient control dashboards to replace Alexa-type devices |
| RM-UI-004 | Feature | High | Ambient tablet display themes for kitchen, entertainment, and hallway use |
...
| ID | Type | Priority | Title |
|---|---|---:|---|
| RM-DEV-001 | Feature | Medium | Add Xcode and Apple-platform coding capability to the developer assistant |
...
| ID | Type | Priority | Title |
|---|---|---:|---|
| RM-HW-001 | Feature | High | AI-assisted electrical design workflow for ESP32 and Nordic hardware |
| RM-HW-002 | Feature | Medium | Flipper-style embedded shell for ESP32 and Nordic devices |

## Document/app conversion
...
| ID | Type | Priority | Title |
|---|---|---:|---|
| RM-LANG-001 | Feature | Medium | Strong multilingual translation app for written and spoken language, with Chinese as a priority language |

## Home / environment / Home Assistant
...
| ID | Type | Priority | Title |
|---|---|---:|---|
| RM-AUTO-MECH-001 | Feature | High | Automotive repair and maintenance assistant with broad general knowledge for all cars and deep classic Mercedes specialization |
