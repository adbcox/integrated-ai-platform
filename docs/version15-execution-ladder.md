...
| Learning / training / attribution | `learning-v14` | `learning-v15` | `learning-v15` | `learning-v15` | building |
...
- `learning-v14`: operational lesson/prevention/prior/reuse loop with verbose run-level lessons and stable machine-readable outputs from benchmark/campaign/curation/attribution/manager-trace artifacts, now with internal code-library consumption and trusted external pattern intake wired into class-based reuse recommendations.
- `learning-v15`: controlled adaptation experiments with gate-linked rollback criteria.
- `learning-v15`: automated class-targeted promotion of validated templates and negative-example bundles into execution defaults.
...
- Learning: `learning-v14` building (verbose artifact-to-action lesson/prevention/prior/reuse loop operational with code-library + trusted external consumption)
