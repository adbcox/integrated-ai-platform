...
| D-17-97: Aider compute redirect to Mac Studio M3 Ultra | IN PROGRESS | added 2026-05-04 — redirect Aider from Mac Mini Ollama (127.0.0.1:11434) to Mac Studio M3 Ultra Ollama (192.168.10.142:11434); audit model parity; update bin/aider_local.sh API_BASE default; doctrine doc. |
