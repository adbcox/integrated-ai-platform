...
| D-17-100: Lidarr full operational configuration | IN PROGRESS | 2026-05-04 — WP-01 promoted. Scope: complete Lidarr operational parity with Sonarr/Radarr by wiring download clients, storage mount/root folder, and post-deploy smoke without triggering actual downloads. |
| D-17-101: Aider doc-authoring permanent Tier-2 reclassification | IN PROGRESS | 2026-05-04 — WP-01 promoted. Scope: permanently remove multi-paragraph doc-authoring from Aider Tier 1 after N=2 source-fidelity failures (qwen2.5-coder:14b and qwen3-coder-next). |
