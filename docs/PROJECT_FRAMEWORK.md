...
| D-17-91: Goose maturity unblock T2 — Gemma 4 vs Qwen3-Coder-Next benchmark | IN PROGRESS | added 2026-05-04 — T2 model benchmark that should have preceded T3. Pull + provenance-verify Gemma 4 26B MoE (3.8B active) and Qwen3-Coder-Next 80B hybrid-attn+MoE (3B active) — both fit RTX 4070 on Threadripper. Re-run D-17-12 benchmark harness 16-cell matrix (lc/refactor/tool-call/agentic × small/medium/large) against both. If either materially outperforms qwen3-coder:30b on C1a class shapes, propose cell-change for new N=5 attempt. Provenance-pull surface-back gate at WP-02. |
