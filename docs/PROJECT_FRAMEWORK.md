...
| D-17-44: Buildarr config-as-code substrate (Radarr + Prowlarr only) — first F11 worked example; Sonarr v4 + Sportarr documented out-of-scope until upstream plugin coverage | IN PROGRESS | Promoted from PHASE_ROADMAP §18.G component 2; reduced scope per pre-flight Q1-Q3; D-17-29 sidecar pattern + D-17-38 vault-agent template |
