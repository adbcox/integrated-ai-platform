...
| D-17-92: Goose maturity unblock T1-sibling — Cisco Provenance Kit deployment | IN PROGRESS | added 2026-05-04 — T1-sibling tooling for D-17-91 model provenance. Deploy Cisco Provenance Kit (OSS Python, F1 0.963 verifies HF model lineage via architecture metadata + tokenizer + weight signatures, CPU-only) as `scripts/verify-model-provenance-cisco.sh` wrapper; fold into existing `pull-new-model.md` runbook for Phase-13+ governance integration. |
