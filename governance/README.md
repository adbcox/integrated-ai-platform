...
- [governance/authority_adr_0018_phase1_local_runtime_closure.md](authority_adr_0018_phase1_local_runtime_closure.md) — records Phase 1 local runtime hardening closure (PHASE-1-CLOSE-1); owns evidence at `governance/phase1_local_runtime_closure_evidence.json`
