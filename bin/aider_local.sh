...
MICRO_TIMEOUT="${MICRO_TIMEOUT:-300}"
SMART_STATUS_ONLY=0
USER_MODEL=""
USER_MAP_TOKENS=""
USER_TIMEOUT=""
...
CMD=(python3 -m aider --no-check-update --no-show-release-notes --analytics-disable --no-auto-commits --no-dirty-commits --yes-always --no-fancy-input --no-browser --edit-format diff)
