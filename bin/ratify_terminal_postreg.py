#!/usr/bin/env python3
"""Reratify terminal promotion matrix after AGCC1 Aider command registration.

Usage: python3 bin/ratify_terminal_postreg.py [--artifact-dir PATH] [--dry-run]
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Reratify terminal matrix post-registration.")
    ...
    proof = run_aider_live_proof(gate, num_runs=3, dry_run=args.dry_run)
    ...
    print(f"\n=== Terminal Matrix Reratification (Post-Registration) ===")
