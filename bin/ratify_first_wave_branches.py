#!/usr/bin/env python3
"""Ratify first-wave domain branches for LAPC1.

Usage: python3 bin/ratify_first_wave_branches.py [--artifact-dir PATH] [--dry-run]
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Ratify first-wave domain branch promotions.")
    parser.add_argument("--artifact-dir", default="artifacts/first_wave_promotion")
    parser.add_argument("--dry-run", action="store_true")
    args = parser.parse_args()

    artifact = ratify_first_wave_promotion(
